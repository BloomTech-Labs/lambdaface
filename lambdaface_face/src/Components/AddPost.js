    ...
    return (
      <div className="add-post__container">
        ...
        <div className="container__right-col">
          <h4>Add a Post</h4>
          <textarea style={{resize: "none"}} className="right-col__text-area" value={this.state.content} onChange={this.handleChange('content')} cols="30" rows="10"></textarea>
          <div className="right-col__bottom-row">
            ...
            {/* TODO: get avatar & name dynamically */}
              <div className="bottom-row__right-circle"></div>
              <span>John Doe</span>
              <Button variant="contained" color="primary" onClick={this.submitPost()}>Post</Button>
            </div>
          </div>
        </div>
      </div>
